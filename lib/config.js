...
module.exports = {
  ...
  // Handle featured on the landing page when signups are closed. Unset means
  // no link, so a self-hosted copy does not advertise someone else's profile.
  featuredHandle: (process.env.FEATURED_HANDLE || '').trim().toLowerCase(),
